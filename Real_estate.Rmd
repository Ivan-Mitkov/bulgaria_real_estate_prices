...
ggplot(growth_df, aes(x = year, y = growth, fill = category)) +
  ...
  scale_fill_viridis(
    ...
    option = "C",
    aesthetics = "fill",
    labels=c("Индекс на растежа на средната работна заплата","Индекс на растежа на цените на недвижимите имоти", "Индекс на потребителските цени")
  )+
...
ggplot(prices, aes(x = factor(year), y = price, fill = category)) +
  ...
  scale_fill_viridis(
    ...
    option = "C",
    aesthetics = "fill",
    labels=c("Средна цена на апартамент-реална","Средна цена на апартамент-изчислена според възможната ипотека")
  )+
  labs(
